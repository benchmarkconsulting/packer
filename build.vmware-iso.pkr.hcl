...
EOF
  source "source.vsphere-iso.base-windows" {
    name                 = "2016"
    floppy_files         = ["${path.root}/answer_files/windowsserver2016/autounattend.xml", "./scripts/windowsserver2016/set-ip.ps1", "./scripts/disable-screensaver.ps1", "./scripts/disable-winrm.ps1", "./scripts/enable-winrm.ps1", "./scripts/install-vmwaretools.ps1", "./scripts/win-updates.ps1"]
  ...
  source "source.vsphere-iso.base-windows" {
    name                 = "2019"
    floppy_files         = ["${path.root}/answer_files/windowsserver2019/autounattend.xml", "./scripts/windowsserver2019/set-ip.ps1", "./scripts/disable-screensaver.ps1", "./scripts/disable-winrm.ps1", "./scripts/enable-winrm.ps1", "./scripts/install-vmwaretools.ps1", "./scripts/win-updates.ps1"]
    guest_os_type        = "windows9Server64Guest"
