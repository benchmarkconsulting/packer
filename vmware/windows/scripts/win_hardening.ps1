<#
.SYNOPSIS
    Script to harden Windows Server 2019.
.DESCRIPTION
    The script to harden Windows Server 2019 VM baseline policies using Desired State Configurations for CIS Benchmark Windows Server 2019 Version 1.1.0.
    modules should be installed
        1. Install-Module -Name AuditPolicyDsc
        2. Install-Module -Name SecurityPolicyDsc
        3. Install-Module -Name NetworkingDsc
        4. Install-Module -Name xPSDesiredStateConfiguration
.EXAMPLE
    
    .\WindowsServer2019.ps1 to generate MOF files
    Then Run -> Start-DscConfiguration -Path .\WindowsServer2019  -Force -Verbose -Wait
#>
...
WindowsServer
Start-DscConfiguration -Path .\WindowsServer -Force -Wait